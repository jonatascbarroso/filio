		...
		return builder.routes()
			...
			.route("download", r -> r.method(HttpMethod.GET)
				...
				.filters(f -> f.hystrix(h -> h.setName(FILE_TRANSFER_CIRCUIT_BREAKER_NAME)
					.setFallbackUri("forward:/" + FILE_TRANSFER_FALLBACK_URI)))
				.uri(FILE_TRANSFER_URL))
